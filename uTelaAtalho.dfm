object frmTeclasAtalho: TfrmTeclasAtalho
  Left = 230
  Top = 90
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object SQLTeclaAtalho: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'SELECT * FROM TECLAS_ATALHO'
      'ORDER BY ID')
    SQLConnection = dmDatabase.scoDados
    Left = 649
    Top = 9
    object SQLTeclaAtalhoID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object SQLTeclaAtalhoTECLA: TStringField
      FieldName = 'TECLA'
      Size = 15
    end
    object SQLTeclaAtalhoDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 50
    end
  end
