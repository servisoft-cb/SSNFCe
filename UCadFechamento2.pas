  ...
  begin
    ...
    begin
      if not(fDMCadFechamento.cdsFechamento_Consulta.Active) or (fDMCadFechamento.cdsFechamento_Consulta.IsEmpty) or
        ...
        exit;
      prc_Fechamento;
      lblTipoFechamento.Caption   := '';
      if fDMCadFechamento.cdsFechamentoTIPO_FECHAMENTO.AsString = 'N' then
      begin
        lblTipoFechamento.Caption    := '*** Em Aberto ***';
        lblTipoFechamento.Color      := clRed;
        lblTipoFechamento.Font.Color := clWhite;
      end
      else
      if fDMCadFechamento.cdsFechamentoTIPO_FECHAMENTO.AsString = 'E' then
      begin
        lblTipoFechamento.Caption := '*** Encerrado com Diferença *** ';
        lblTipoFechamento.Color      := clBlue;
        lblTipoFechamento.Font.Color := clWhite;
      end;
      if fDMCadFechamento.cdsFechamentoTIPO_FECHAMENTO.AsString = 'S' then
      begin
        lblTipoFechamento.Caption := '*** Encerrado *** ';
        lblTipoFechamento.Color      := clGreen;
        lblTipoFechamento.Font.Color := clWhite;
      end;
    end;
  end;
