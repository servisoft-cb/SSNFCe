object DMNFCe: TDMNFCe
  ...
  object mItensNFe: TClientDataSet
    ...
    Top = 328
    Data = {
      140800009619E0BD01000000180000005500000000000300000014080646696C
      ...
      000000000E506572635F49636D735F4566657408000400000000001250455243
      5F424153455F5245445F4546455408000400000000000000}
    ...
    object mItensNFePERC_BASE_RED_EFET: TFloatField
  ...
  object ACBrNFeDANFeRL2: TACBrNFeDANFeRL
  ...
  object qProduto: TSQLQuery
    ...
    object qProdutoPESOLIQUIDO: TFloatField
    ...
    object qProdutoCOMPLEMENTO: TStringField
      FieldName = 'COMPLEMENTO'
      Size = 200
    end
    ...
    object qProdutoORIGEM_PROD: TStringField
      FieldName = 'ORIGEM_PROD'
      FixedChar = True
      Size = 1
    end
    object qProdutoCODSITCF: TStringField
      FieldName = 'CODSITCF'
      Size = 5
    end
    object qProdutoPERC_REDUCAOICMS: TFloatField
    ...
    object qProdutoID_SUBGRUPO: TIntegerField
      FieldName = 'ID_SUBGRUPO'
    end
    object qProdutoID_MARCA: TIntegerField
      FieldName = 'ID_MARCA'
    end
    object qProdutoID_FORNECEDOR: TIntegerField
      FieldName = 'ID_FORNECEDOR'
    end
    object qProdutoPERC_REDUCAOICMSSUBST: TFloatField
      FieldName = 'PERC_REDUCAOICMSSUBST'
    end
    object qProdutoUSA_PERC_IMP_INTERESTADUAL: TStringField
      FieldName = 'USA_PERC_IMP_INTERESTADUAL'
      FixedChar = True
      Size = 1
    end
    object qProdutoPERC_PIS: TFloatField
      FieldName = 'PERC_PIS'
    end
    object qProdutoPERC_COFINS: TFloatField
      FieldName = 'PERC_COFINS'
    end
    object qProdutoPERC_ICMS_IMP: TFloatField
      FieldName = 'PERC_ICMS_IMP'
    end
    object qProdutoPERC_IPI_IMP: TFloatField
      FieldName = 'PERC_IPI_IMP'
    end
    object qProdutoREFERENCIA_PADRAO: TStringField
      FieldName = 'REFERENCIA_PADRAO'
    end
    object qProdutoID_SITTRIB_CF: TIntegerField
      FieldName = 'ID_SITTRIB_CF'
    end
    object qProdutoID_CLIENTE: TIntegerField
      FieldName = 'ID_CLIENTE'
    end
    object qProdutoPRECO_REVENDA: TFMTBCDField
      FieldName = 'PRECO_REVENDA'
      Precision = 15
      Size = 10
    end
    object qProdutoUNIDADE2: TStringField
      FieldName = 'UNIDADE2'
      Size = 6
    end
    object qProdutoID_CSTICMS: TIntegerField
      FieldName = 'ID_CSTICMS'
    end
    object qProdutoPERC_ICMS_NFCE: TFloatField
      FieldName = 'PERC_ICMS_NFCE'
    end
    object qProdutoCALCULAR_ST: TStringField
      FieldName = 'CALCULAR_ST'
      FixedChar = True
      Size = 1
    end
    object qProdutoCOD_BARRA2: TStringField
      FieldName = 'COD_BARRA2'
      Size = 14
    end
    object qProdutoQTD_EMBALAGEM: TFloatField
