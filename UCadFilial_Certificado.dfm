object frmCadFilial_Certificado: TfrmCadFilial_Certificado
  Left = 311
  Top = 81
  Width = 849
  Height = 613
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'N'#250'mero S'#233'rie'
            Width = 216
            Visible = True
          end
          item
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Consulta Lote Envio'
            Width = 64
            Visible = True
          end
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Intervalo Tentativas'
            Width = 64
            Visible = True
          end>
      end
        ...
        object TS_Dados: TRzTabSheet
          ...
          object pnlCadastro: TPanel
            ...
            object Label7: TLabel
              ...
              Width = 112
              Height = 13
              Caption = 'Intervalo de Tentativas:'
            end
            ...
            object RxDBLookupCombo1: TRxDBLookupCombo
              ...
              LookupField = 'ID'
              LookupDisplay = 'NOME'
              LookupSource = DMFilial_Certificado.dsFilial
              TabOrder = 0
            end
            ...
            object DBEdit4: TDBEdit
              ...
              Width = 185
              Height = 21
              DataField = 'AGUARDARCONSULTARETORNO'
              DataSource = DMFilial_Certificado.dsFilial_Certificado
              TabOrder = 5
            end
            ...
            object DBCheckBox1: TDBCheckBox
              ...
              DataField = 'CONSULTARLOTEAPOSENVIO'
              DataSource = DMFilial_Certificado.dsFilial_Certificado
              TabOrder = 7
              ValueChecked = 'S'
              ValueUnchecked = 'N'
